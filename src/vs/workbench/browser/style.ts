...
registerThemingParticipant((theme: ITheme, collector: ICssStyleCollector) => {
	...
	if (theme.type === HIGH_CONTRAST) {
		collector.addRule(`
		.monaco-workbench.hc-black [tabindex="0"]:focus,
		.monaco-workbench.hc-black .synthetic-focus,
		.monaco-workbench.hc-black select:focus,
		.monaco-workbench.hc-black input[type="button"]:focus,
		.monaco-workbench.hc-black input[type="text"]:focus,
		.monaco-workbench.hc-black textarea:focus,
		.monaco-workbench.hc-black input[type="checkbox"]:focus {
			outline-style: solid;
			outline-width: 1px;
		}

		.monaco-workbench.hc-black .monaco-tree.focused.no-focused-item:focus:before {
			outline-width: 1px;
			outline-offset: -2px;
		}
